      ...
      <section id="projects" className="projects">
        ...
        <div className="project-list">
          <div className="card">
            ...
            <p>
              A group project that focuses on creating a barangay website that helps
              share announcements, events, and services in a simple and accessible way.
            </p>
          </div>
      ...
      <section id="contact" className="contact">
        <div className="contact-box">
          ...
          <div className="contact-links">
            ...
            <a href="https://github.com/robangelolang" target="_blank" rel="noreferrer">
              GitHub
            </a>
          </div>
